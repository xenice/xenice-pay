...
js;
    ...
    {
        $style = $field['style']??'regular';
        $button = sprintf('<button class="button button-default xenice-img-select-%s">%s</button>',$field['id'],__("Select"));
...
js;
    ...
    private function imgs($field)
    {
        ...
        $str .='</div>';
        $str .= sprintf('<button class="button button-default xenice-img-add-%s">%s</button>',$field['id'],__("Add"));
...
js;
    ...
    private function slide($field)
    {
        $add_image = function($index, $value = [])use($field){
            ...
            $str .= '<div style="margin-bottom:10px;font-weight:bold;">' . __('Image') . ' ' . $index .'</div>';
            $str .= '<div class="slide-data"><div style="margin-bottom:5px">' . __('URL:').'</div>';
        ...
        $str .= sprintf('</div><button class="button button-default xenice-slide-add-%s">%s</button>', $field['id'], __('Add'));
